        ...
        >
          {galleryItems.map((item, index) => (
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-brand-black/40 group-hover:bg-brand-red/60 transition-all duration-500 flex items-end p-8 opacity-0 group-hover:opacity-100">
