...
export function Newsletter() {
  ...
  return (
    <section className="w-full bg-gray-900 text-white py-12 sm:py-16 lg:py-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            required
            className="flex-1 px-4 py-3 rounded-lg text-gray-900 outline-none focus:ring-2 focus:ring-orange-500 transition-all"
          />
          <Button
            type="submit"
